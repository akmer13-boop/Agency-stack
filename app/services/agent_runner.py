...
_ROP_TOOL_INSTRUCTIONS = (
    ...
    "ID и число ссылок. Не называй отсутствующий в справочнике manager ID удалённым, "
    "уволенным или неактивным без отдельного доказательства. Не придумывай значения "
    "для пустых полей и не обещай автоматическое исправление CRM. "
