...
_ROP_TOOL_INSTRUCTIONS = (
    ...
    "Не проси пользователя экспортировать сделку, если get_rop_deal доступен. "
    "get_rop_deal не передаёт в LLM тексты timeline-комментариев, описаний активностей "
    "или контакты клиента; не выдумывай их содержание. "
